...
Give it a spin with ScoreSaber if you want:
[Add ScoreSaber Latest to Encore](encore://add-source?url=https://raw.githubusercontent.com/ScoreSaber/pc-mod/main/index.json)
...
I haven't thought about how to do it the other way around yet so, gotta do that at some point lol, like what if SongCore wanted to use custom repos, all the mods on BeatMods that depend on it would explode
