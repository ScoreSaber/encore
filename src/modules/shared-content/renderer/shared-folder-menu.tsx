...
// links are managed on the shared content page, so the tabs only point there
export function SharedFolderMenuItems({ separated, onManage }: { separated?: boolean; onManage: () => void }) {
