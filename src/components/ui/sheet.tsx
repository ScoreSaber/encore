   ...
   return (
      <SheetPortal>
         ...
         >
            {children}
            {showCloseButton && (
               <SheetPrimitive.Close className="data-[state=open]:bg-secondary absolute top-4 right-4 cursor-default rounded-xs opacity-70 transition-opacity outline-none hover:opacity-100 disabled:pointer-events-none">
